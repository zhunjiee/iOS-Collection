...
{
    NSString *name =@"MBProgressHUD+Extension/sources/success.png";
    [self showCustomIconInWindow:name message:Message];
}
+ (void)showErrorMessage:(NSString *)Message
{
    NSString *name =@"MBProgressHUD+Extension/sources/error.png";
    [self showCustomIconInWindow:name message:Message];
}
+ (void)showWarnMessage:(NSString *)Message
{
    NSString *name =@"MBProgressHUD+Extension/sources/warn.png";
    [self showCustomIconInWindow:name message:Message];
}
